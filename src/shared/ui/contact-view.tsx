...
export function ContactView({ settings }: { settings: SiteSettings | null }) {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2 max-w-3xl mx-auto mb-10 md:mb-16">
                ...
                <div className="bg-surface-card border border-border-light rounded-xl p-5 md:p-8 text-center hover:shadow-soft transition-all">
                    ...
                    <div className="flex justify-center gap-4">
                        <a
                            ...
                            className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 text-text-main hover:text-primary-600 hover:bg-primary-50 transition-all border border-border-light shadow-sm"
                            title="Instagram"
                        >
